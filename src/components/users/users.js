...
if (result.length>0){
  console.log(result)
  let usrName = (JSON.parse(JSON.stringify(result[0])).email)
  let usrPas = (JSON.parse(JSON.stringify(result[0])).pas)
  console.log(usrName +' '+usrPas)
  localStorage.setItem('Имя пользователя', usrName);
        ...
        <div className="col-md-5 mx-auto">
          <div id="first">
            <div className="myform form ">
              ...
              <form onSubmit={submit} method="post" name="login">
